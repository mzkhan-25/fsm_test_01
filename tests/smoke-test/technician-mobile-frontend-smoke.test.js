/**
 * Smoke test for Technician Mobile Frontend Service
 * Tests: Health check (service responding) and basic UI rendering
 */

const { request, waitForService } = require('../helpers/http-client');

const SERVICE_URL = 'http://localhost:5176'; // Different port to avoid conflicts
const SERVICE_NAME = 'technician-mobile-frontend';
