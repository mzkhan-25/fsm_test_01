/**
 * Smoke test for Task Management Frontend Service
 * Tests: Health check (service responding) and basic UI rendering
 */

const { request, waitForService } = require('../helpers/http-client');

const SERVICE_URL = 'http://localhost:5175'; // Different port to avoid conflicts
const SERVICE_NAME = 'task-management-frontend';
